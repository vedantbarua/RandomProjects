...
There are currently `141` POCs here. Some are infrastructure primitives, some are realtime systems, and some are end-user product simulations. The common goal is the same: make the underlying system behavior visible enough that someone can understand the design tradeoffs quickly.
...
| [personal-medication-interaction-safety-poc](personal-medication-interaction-safety-poc/README.md) | React, Node, Express, SQLite-style storage, and Redis-style caching for medication interaction checks, duplicate ingredients, refill risk, missed-dose reminders, caregiver escalation, and audits. |
| [personal-medical-appointment-prep-poc](personal-medical-appointment-prep-poc/README.md) | React, Node, Express, SQLite-style storage, and Redis-style caching for appointment prep, symptom timelines, clinician questions, follow-up instructions, summary exports, reminders, and audits. |
...
| [personal-home-inventory-recall-alert-poc](personal-home-inventory-recall-alert-poc/README.md) | React, Node, Express, SQLite, and Redis-style home inventory recall alerting with feed ingestion, item matching, alert dedupe, notification retries, and audits. |
...
- [personal-home-inventory-recall-alert-poc](personal-home-inventory-recall-alert-poc/README.md)
- [personal-medical-appointment-prep-poc](personal-medical-appointment-prep-poc/README.md)
- [personal-medication-interaction-safety-poc](personal-medication-interaction-safety-poc/README.md)
...
- `141/141` POCs have a `README.md`
- `141/141` POCs have a technical companion doc
- `132/141` POCs have an `IMPROVEMENTS.md`
